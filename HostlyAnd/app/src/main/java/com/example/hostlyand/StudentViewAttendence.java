...
//
//public class StudentViewAttendence extends AppCompatActivity {
//
//    @Override
...
public class StudentViewAttendence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ip = sh.getString("url", "");
        url = ip + "student_view_attendance";
                ...
                try {
                    ...
                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                        ...
                        for (int i = 0; i < js.length(); i++) {
                            ...
                            att[i] = u.getString("status");
                            stdname[i] = u.getString("student_name");
                            date[i] = u.getString("date");


                        }
                        li.setAdapter(new CustomviewAttendence(getApplicationContext(), pid, stdname,att,date));
