...
//
//public class StudentviiewAddonStatus extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_studentviiew_addon_status);
//    }
//}
...
//                        date = new String[js.length()];
                        ...
                        for (int i = 0; i < js.length(); i++) {
                            ...
                            att[i] = u.getString("time");
                            status[i] = u.getString("status");
//                            date[i] = u.getString("date");


                        }
                        li.setAdapter(new Customstudentviewaddontime(getApplicationContext(), sid, att,status));
